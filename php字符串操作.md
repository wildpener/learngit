...
单引号定义的字符串：```php $hello = 'hello world'; ```

双引号定义的字符串：```php $hello = "hello world"; ```
...
如果有一个字符串$str = 'I want to study at Internet';，怎么样找到其中的Internet在哪个位置呢？
...
```php
$str = 'I want to study at Internet';
$pos = strpos($str, 'Internet');
echo $pos;//结果显示19，表示从位置0开始，Internet在第19个位置开始出现
```
